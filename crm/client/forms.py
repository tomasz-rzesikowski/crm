...
class ClientForm(FlaskForm):
    ...
    address_street_and_number = StringField('Adres', description='Ulica i nr.')

    address_zipcode_and_city = StringField('Miejscowość', description='Kod pocztowy i miejscowość.')
